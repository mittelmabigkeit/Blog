...
<body>
    ...
    <div class="login-block">         <!-- login-block-->   
	 <center><form action="#"> 	 <!-- elements of form -->
    ...
    <ul>
     <li><a href="index.html">Статья 1</a></li>
     <li><a href="indexone.html">Статья 2</a></li>
     <li><a href="indextwo.html">Статья 3</a></li>
     <li><a href="indexthree.html">Статья 4</a></li>
   </ul>
   	</div>                                                               
